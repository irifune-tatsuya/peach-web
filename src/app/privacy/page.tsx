  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl p-4 pb-[60px] text-sm md:pb-[156px]">
        ...
        <h2 className={headingClasses}>第1条（個人情報）</h2>
        <p className="mb-12">
          「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
        </p>
        <h2 className={headingClasses}>第2条（個人情報の収集方法）</h2>
        <p className="mb-12">
          弊社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレスなどの個人情報をお尋ねすることがあります。またユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を弊社の提携先（情報提供元、広告主、広告配信先などを含みます。以下「提携先」といいます。）などから収集することがあります。
        </p>
        <h2 className={headingClasses}>第3条（個人情報を収集・利用する目的）</h2>
        ...
        <h2 className={headingClasses}>第4条（利用目的の変更）</h2>
        <ol className={listClasses}>
          <li>
            弊社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。
          </li>
          <li>
            利用目的の変更を行った場合には，変更後の目的について，弊社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。
          </li>
        </ol>
        <h2 className={headingClasses}>第5条（個人情報の第三者提供）</h2>
        <ol className={listClasses}>
          <li>
            弊社は次に掲げる場合を除いてあらかじめユーザーの同意を得ることなく、第三者に個人情報を提供することはありません。ただし個人情報保護法その他の法令で認められる場合を除きます。
            <ol className={nestedListClasses}>
              ...
              <li>
                国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって本人の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき
              </li>
              <li>
                予め次の事項を告知あるいは公表し、かつ弊社が個人情報保護委員会に届出をしたとき
                <ol className={doubleNestedListClasses}>
        ...
        <h2 className={headingClasses}>第6条（個人情報の開示）</h2>
        <ol className={listClasses}>
          <li>
            弊社は、本人から個人情報の開示を求められたときは、本人に対して遅滞なくこれを開示します。ただし開示することにより次のいずれかに該当する場合は、その全部または一部を開示しないこともあり、開示しない決定をした場合にはその旨を遅滞なく通知します。なお個人情報の開示に際しては1件あたり1,000円の手数料を申し受けます。
            <ol className={nestedListClasses}>
        ...
        <h2 className={headingClasses}>第7条（個人情報の訂正および削除）</h2>
        <ol className={listClasses}>
          <li>
        ...
        <h2 className={headingClasses}>第8条（個人情報の利用停止等）</h2>
        <ol className={listClasses}>
          <li>
          ...
          <li>
            前2項にかかわらず、利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であってユーザーの権利利益を保護するために必要なこれに代わるべき措置をとれる場合はこの代替策を講じるものとします。
          </li>
        </ol>
        <h2 className={headingClasses}>第9条（プライバシーポリシーの変更）</h2>
        <ol className={listClasses}>
          <li>
        ...
        <h2 className={headingClasses}>第10条（お問い合わせ窓口）</h2>
        <p>
          本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。
          <br />
          <br />
          住所：岡山県岡山市東区中川町405-1-201
          <br />
          社名：合同会社ピーチウェブ
          <br />
          Eメールアドレス：irifune@peach-web.co.jp
        </p>
        <br />
        <br />
