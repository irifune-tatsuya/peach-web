    ...
    <>
      ...
      <Box maxW={1152} mx={'auto'} p={4} fontSize={'small'}>
        ...
        <OrderedList mb={12}>
          ...
          <ListItem>
            弊社は本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称の如何に関わらず，本規約の一部を構成するものとします。
          </ListItem>
          <ListItem>
        ...
        <OrderedList mb={12}>
          <ListItem>
            本サービスにおいては，登録希望者が本規約に同意の上，弊社の定める方法によって利用登録を申請し，当社がこれを承認することによって，利用登録が完了するものとします。
          </ListItem>
          <ListItem>
          ...
          <ListItem>その他，弊社が利用登録を相当でないと判断した場合</ListItem>
        </OrderedList>
        <Heading as="h2" my="20px" fontSize={'large'} className={styles.title}>
          第3条（ユーザーIDおよびパスワードの管理）
        </Heading>
        <OrderedList mb={12}>
          <ListItem>弊社サービスの提供・運営のため</ListItem>
          <ListItem>
        ...
        <Text mb={6}>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</Text>
        <OrderedList mb={12}>
          ...
          <ListItem>弊社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</ListItem>
        ...
        <OrderedList mb={12}>
          ...
          <OrderedList styleType="lower-roman">
            ...
            <ListItem>その他，弊社が本サービスの提供が困難と判断した場合</ListItem>
          </OrderedList>
          <ListItem>
        ...
        <OrderedList mb={12}>
          ...
          <OrderedList styleType="lower-roman">
            ...
            <ListItem>弊社からの連絡に対し，一定期間返答がない場合</ListItem>
            <ListItem>本サービスについて，最終の利用から一定期間利用がない場合</ListItem>
            <ListItem>その他，弊社が本サービスの利用を適当でないと判断した場合</ListItem>
          </OrderedList>
          <ListItem>
            弊社は，本条に基づき当社が行った行為によりユーザーに生じた損害について，一切の責任を負いません。
          </ListItem>
        </OrderedList>
        <Heading as="h2" my="20px" fontSize={'large'} className={styles.title}>
          第8条（退会）
        ...
        <OrderedList mb={12}>
          ...
          <ListItem>
            弊社は，本サービスに起因してユーザーに生じたあらゆる損害について、当社の故意又は重過失による場合を除き、一切の責任を負いません。ただし，本サービスに関する当社とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合，この免責規定は適用されません。
          </ListItem>
          <ListItem>
